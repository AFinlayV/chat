...
def init_tools(llm):
    if VERBOSE:
        print("Loading tools...")
    # TODO fix wolfram alpha ssl cert error
...
def init_memory(llm):
    ...
    # TODO fix memory to fit within the token limit of the LLM. I want to change to an embedding based memory similar to RAVEN (david shapiro)
